      ...
      if (Command == "MonthlyReport")
      {
        ...
        foreach (int num1 in ints)
        {
          ...
          if (userGuid != "")
          {
            ...
            if (list1.Any(a =>
            {
              if (a.userId == d_id && a.questionText != null && a.questionText.ToLower().Contains("highest"))
            ...
            if (list1.Any(a =>
            {
              if (a.userId == d_id && a.questionText != null && a.questionText.ToLower().Contains("career"))
            ...
            if (list1.Any(a =>
            {
              if (a.userId == d_id && a.questionText != null && a.questionText.ToLower().Contains("trainer"))
            ...
            if (list1.Any(a =>
            {
              if (a.userId == d_id && a.questionText != null && a.questionText.ToLower().Contains("credential"))
            ...
            }))
            {
              ...
              {
                if (c.userId == d_id && c.questionText != null && c.questionText.ToLower().Contains("credential"))
              ...
              for (int i = 0; i < num2 + 1; ++i)
              {
                ...
                if (source.Any(x =>
                {
                  if (x.userId == d_id && x.questionText != null && x.questionText.ToLower().Contains("credential"))
                    return x.questionText.ToLower().Contains("type");
                  return false;
                }))
                  str2 = source.FirstOrDefault(x =>
                  {
                    if (x.userId == d_id && x.questionText != null && x.questionText.ToLower().Contains("credential") && x.questionText.ToLower().Contains("type"))
                ...
                if (source.Any(x =>
                {
                  ...
                  {
                    if (x.userId == d_id && x.questionText != null && x.questionText.ToLower().Contains("credential") && x.questionText.ToLower().Contains("name"))
                      return x.subordinal == i;
                    return false;
                  }).questionResponse;
                str1 = str1 + str2 + ":" + str3 + ",";
