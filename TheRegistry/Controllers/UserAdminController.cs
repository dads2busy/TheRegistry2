...
namespace Questionnaire2.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Email,Id,FirstName,LastName,MiddleInitial,PhoneNumber,Address1,City,State,ZIP,DOB")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
